...
namespace Adobe.Target.Delivery.Model
{
    ...
    public partial class UnexpectedError : IEquatable<UnexpectedError>, IValidatableObject
    {
        /// <summary>
        ...
        public UnexpectedError(int status = default(int), string message = default(string))
        {
            ...
            this.Message = message ?? throw new ArgumentNullException("message is a required property for UnexpectedError and cannot be null");
        }
        ...
        {
            return this.Equals(input as UnexpectedError);
        }

        /// <summary>
        /// Returns true if UnexpectedError instances are equal
        /// </summary>
        /// <param name="input">Instance of UnexpectedError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnexpectedError input)
        {
            if (input == null)
                return false;
