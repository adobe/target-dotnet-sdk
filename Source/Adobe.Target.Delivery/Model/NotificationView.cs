...
namespace Adobe.Target.Delivery.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotificationView")]
    public partial class NotificationView : IEquatable<NotificationView>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="state">View state token..</param>
        public NotificationView(string name = default(string), string key = default(string), string state = default(string))
        {
            this.Name = name;
            this.Key = key;
            this.State = state;
        ...
        {
            return this.Equals(input as NotificationView);
        }

        /// <summary>
        /// Returns true if NotificationView instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationView input)
        {
            if (input == null)
                return false;
