...
namespace Adobe.Target.Delivery.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PrefetchMboxResponse")]
    public partial class PrefetchMboxResponse : IEquatable<PrefetchMboxResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PrefetchMboxResponse);
        }

        /// <summary>
        /// Returns true if PrefetchMboxResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PrefetchMboxResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrefetchMboxResponse input)
        {
            if (input == null)
                return false;
