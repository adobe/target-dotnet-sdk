...
namespace Adobe.Target.Client.OnDevice
{
    ...
    internal sealed class OnDeviceDecisioningEvaluator
    {
        private readonly RuleLoader ruleLoader;

        public OnDeviceDecisioningEvaluator(RuleLoader ruleLoader) => this.ruleLoader = ruleLoader;

        internal OnDeviceDecisioningEvaluation EvaluateLocalExecution(TargetDeliveryRequest request)
        {
            // TODO: Implement
            return new OnDeviceDecisioningEvaluation(true);
        }
    }
}
